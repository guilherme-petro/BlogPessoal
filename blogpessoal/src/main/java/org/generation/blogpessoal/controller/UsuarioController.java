...
public class UsuarioController {
	...
	public ResponseEntity<List<Usuario>> findByNomeUsuario(@PathVariable String texto){
		return ResponseEntity.ok(repository.findAllByNomeContainingIgnoreCase(texto));
	}
